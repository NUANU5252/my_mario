...
class Node:
    ...
    def add_children(self, *children): # 가변 개수 인자 엄밀히 말해 튜플
    ...
    def run(self):
        for pos in range(self.prev_running_pos, len(self.children)):
            ...
            if BehaviorTree.RUNNING == result:
                ...
                return BehaviorTree.SUCCESS # 하나라도 성공하면
        self.prev_running_pos = 0
        return BehaviorTree.FAIL # 전부 다 실패
    ...
    def run(self):
        for pos in range(self.prev_running_pos, len(self.children)):
            ...
            if BehaviorTree.RUNNING == result:
                ...
                self.prev_running_pos = 0
                return BehaviorTree.FAIL # 하나라도 실패하면
        self.prev_running_pos = 0
        return BehaviorTree.SUCCESS # 전부 다 성공
